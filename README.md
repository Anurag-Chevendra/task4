...
## Objectives
Use a decompiler of your choice and start analysing the pseudo code. Difficiculty is beginner level hence there are no hints provided. I prefer [IDA](https://hex-rays.com/ida-free/). Also, [this playlist](https://www.youtube.com/watch?v=tWSa1L5L394) might be useful just for starters. **Your goal is you create a similar program in python.** During assesment, only the python file created by you (which mimics figure_this_out.exe) will be looked under a microscope. All the best!
### Reverse Engineering
